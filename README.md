...
Sukonfigūruota programos Doxygen dokumentacija. Atlikti Unit testai panaudojant Google Test tipo projektą. Sukurtas programos instaliavimo failas "StudentoDB_Installer.exe".
